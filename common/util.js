...
UTIL.threeFree = function UTILThreeFree(scene, mesh) {
    ...
    if (_.get('mesh.material.uniforms.sphereTexture')) {
        mesh.material.uniforms.sphereTexture.value.dispose();
    }
    if (_.get('mesh.material.uniforms.texture')) {
...
/**
 * Returns the median value for an array of numbers
 * @param {Array} values
 * @returns {*}
 */
UTIL.median = function UTILmedian(values) {
