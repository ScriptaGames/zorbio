...
//                          NETWORK SETTINGS                          //
////////////////////////////////////////////////////////////////////////
config.ENABLE_HTTP_SERVER       = false;  // Run a local http server, should only be for development
...
config.NUM_GAME_INSTANCES       = 2;      // How many game instances to spawn on the server
...
config.FOOD_DENSITY                = 37;    // How much food there is, total food = this number cubed
