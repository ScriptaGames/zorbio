...
ZOR.DrainView = function ZORDrainView(playerView, scene) {
    ...
    this.material = new THREE.ShaderMaterial({
        uniforms: {
            ...
            erColor       : { type : "c",  value : this.playerView.skin.material.uniforms.color.value },
...
ZOR.DrainView.prototype.updateUniforms = function ZORDrainViewUpdateUniforms( drainee, distance ) {
    ...
    this.material.uniforms.eeColor.value = drainee.view.skin.material.uniforms.color.value;
